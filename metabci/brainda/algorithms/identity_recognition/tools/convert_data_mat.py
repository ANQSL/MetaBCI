...
parser.add_argument("--config_path", default="../config/config_mat.yaml", type=str)
parser.add_argument("--data_file", default="../data2/val.txt", type=str)
parser.add_argument("--save_file", default="../data2/val.jsonl", type=str)
